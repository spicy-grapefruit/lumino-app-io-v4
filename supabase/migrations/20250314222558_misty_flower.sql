/*
  ...
  1. Changes
    - Add comments_count column to book_notes table
    - Create comments table for storing post comments
    - Add trigger to maintain comments count
    
  2. Implementation Details
    - comments table with note_id reference
    - Automatic comments_count updates via trigger
